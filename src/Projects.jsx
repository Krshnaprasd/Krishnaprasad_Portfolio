        ...
        <>
            ...
            <div className="text-center fs-2 fw-bold name-font pt-3 pb-4">Projects</div>
                ...
                <Accordion>
                    <Accordion.Item eventKey="0">
                        <Accordion.Header>
                            <span className='fs-5 fw-bold'>E-connect - HRM System</span></Accordion.Header>
                        <Accordion.Body>
                            <div className='d-flex justify-content-center'>
                            <Card  style={{ width: '60rem' }}>
                                ...
                                <Card.Body>
                                    ...
                                    <p>Environment: React.js, SpringBoot, H2 Database, Email Integration</p>
                                  
                                    <span className='fs-3 fw-bold'> User</span> <br></br><br></br>
                                      <ul>
                                        <li>About the company, vision & mission, courses to be taken these has to be detailed.</li>
                                   
                                        <li>Employees can access their attendance, salary details, and punch lists effortlessly.</li>
                                   
                                        <li>Manage personal details such as address, bank info, and other basic information with ease.</li>
                                    
                                        <li>Request leave, permission, and correct punch details through a simple interface, improving overall user experience.</li>
                               
   
                                    </ul>
                                    <span className='fs-3 fw-bold'> Admin</span> <br></br><br></br>
                                    <ul>
                                        <li>Full control over managing employees, including adding new hires, tracking attendance, and managing salary disbursements.</li>
                                        <li>Real-time insights into employee counts and job applications.</li>
                                    </ul>
                                    <span className='fs-3 fw-bold'> Career</span> <br></br><br></br>
                                    <ul>
                                        <li>A dedicated Career Page where job openings can be posted and applicants can apply seamlessly.</li>
                                        <li>Track applications in real time with a fully integrated system for HR teams to monitor, evaluate, and manage recruitment.</li>
                                    </ul>
                                    </Card.Text>
                                </Card.Body>
                            </Card>
